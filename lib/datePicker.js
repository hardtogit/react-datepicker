...
var _pickerLine = require('./pickerLine');

var _pickerLine2 = _interopRequireDefault(_pickerLine);
            ...
            _this.setState(function (_ref) {
                ...
                if (_this.props.labels.split(',').indexOf('day') != -1) {
                    if (name === 'year' && valueGroups.month === '02') {
                        ...
                        if (value === '02') {
                            if (_this.isRun(valueGroups.year)) {
                                nextState.optionGroups = _extends({}, optionGroups, {
                                    day: {
                                        list: _this.generateNumberArray(1, 29),
                                        defaultValue: valueGroups.day,
                        ...
                        } else if (['01', '03', '05', '07', '08', '10', '12'].indexOf(value) > -1 && ['01', '03', '05', '07', '08', '10', '12'].indexOf(valueGroups.month) < 0) {
                            nextState.optionGroups = _extends({}, optionGroups, {
                                day: {
                                    list: _this.generateNumberArray(1, 31),
                                    defaultValue: valueGroups.day,
                                    displayValue: function displayValue(item) {
                                        return item;
                                    }
                        ...
                        } else if (['01', '03', '05', '07', '08', '10', '12'].indexOf(value) < 0 && ['01', '03', '05', '07', '08', '10', '12'].indexOf(valueGroups.month) > -1) {
                            nextState.optionGroups = _extends({}, optionGroups, {
                                day: {
                                    list: _this.generateNumberArray(1, 30),
                                    defaultValue: valueGroups.day,
                                    displayValue: function displayValue(item) {
                                        return item;
                                    }
                        ...
                        _react2.default.createElement(
                            ...
                            function () {
                                ...
                                for (name in optionGroups) {
                                    pickerArr.push(_react2.default.createElement(_pickerLine2.default, {
