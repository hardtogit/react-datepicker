...
var picker = exports.picker = {
  ...
  userSelect: 'none'
    ...
    pickerInner = exports.pickerInner = {
  position: 'relative',
  height: '100%',
  width: '100%',
  ...
  top: '50%'
    ...
    pickerRuleCenter = exports.pickerRuleCenter = {
  zIndex: 2,
  borderTop: '1px solid rgba(0,0,0,.1)',
  borderBottom: '1px solid rgba(0,0,0,.1)'
},
    pickerList = exports.pickerList = {
  zIndex: 1,
