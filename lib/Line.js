...
var Index = function (_Component) {
    ...
    function Index(props) {
        ...
        _this.handleTouchMove = function (e) {
            ...
            var distance = (e.nativeEvent.changedTouches[0].pageY - _this.startY) / 36 * 20;
            ...
            _this.line.style.transform = 'perspective(1000px) rotateY(0deg) rotateX(' + result + 'deg)';
        };
        ...
        _this.handleTouchEnd = function (e) {
            ...
            _this.transformX = 20 * activeItem;
