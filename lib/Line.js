...
var quartEaseOut = function quartEaseOut(t, b, s, d) {
...
var Line = function (_Component) {
  ...
  function Line(props) {
    ...
    _this.countDistance = function (e) {
      var $this = _this;
      var nowTime = e.timeStamp || Date.now();
      var v = (e.nativeEvent.changedTouches[0].pageY - _this.lastMoveStart) / (nowTime - _this.lastMoveTime);
